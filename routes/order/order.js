...
const {createOrder, getOrderById, updateOrderToPay ,getOrdersToDeliver, getDeliveredOrders, getUnpaidOrders, updateOrderToDeliver,getMyOrders, getTransfer, updateTransferOrder, getAllOrders, getTotalRevenue} = require("../../controllers/order/order")
...
router.put("/update_transfer/:order_id", ensureLogin, adminAccess(["admin", "super admin"]), updateTransferOrder)
