...
const { AddPages, listPages,updatePages, getSinglePage, updateLogoImg, removeAdPage,searchPages,listPagesByCategory, updateStatus } = require("../../controllers/Agency/pages");
...
router.get("/:categoryId", ensureLogin, listPagesByCategory)
...
router.get("/search", ensureLogin,  searchPages)
